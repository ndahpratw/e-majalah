...
class Layout3Controller extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $request->validate([
            ...
            'isi_konten_5' => 'required',
            'isi_konten_6' => 'required',
            'gambar_1' => 'required',
            'gambar_2' => 'required',
            'gambar_3' => 'required',
            'gambar_4' => 'required',
        ...
        $gambar_10 = $request->file('gambar_10');
        $imageName10 = now()->format('ymdHis') . '-' . '-' . $detail_konten->judul . '-' . 'gambar-10' . '.' . $gambar_10->extension();
        $gambar_10->move(public_path('assets/img/konten/'.$detail_konten->konten->topik), $imageName9);

        $gambar_11 = $request->file('gambar_11');
        $imageName11 = now()->format('ymdHis') . '-' . '-' . $detail_konten->judul . '-' . 'gambar-11' . '.' . $gambar_11->extension();
        $gambar_11->move(public_path('assets/img/konten/'.$detail_konten->konten->topik), $imageName9);
        ...
        $data_konten->isi_konten_5 = $request->isi_konten_5;
        $data_konten->isi_konten_6 = $request->isi_konten_6;
        ...
        $data_konten->gambar_10 = $imageName10;
        $data_konten->gambar_11 = $imageName11;
    ...
    public function show(string $id)
    {
        ...
        return view('pages/admin/layout/layout3', compact('detail_konten'));
    }
    ...
    public function update(Request $request, string $id)
    {
        ...
        $detail_konten = DetailKonten::findOrFail($request->id);
        $data_konten = Layout3::findOrFail($id);
        ...
        if ($request->hasFile('gambar_10')) {
            // Hapus file foto sebelumnya dari penyimpanan
            if ($data_konten->gambar_10 && file_exists(public_path('assets/img/konten/'.$detail_konten->konten->topik.'/'. $data_konten->gambar_10))) {
                unlink(public_path('assets/img/konten/'.$detail_konten->konten->topik.'/'. $data_konten->gambar_10));
            }

            $gambar_10 = $request->file('gambar_10');
            $imageName10 = now()->format('ymdHis') . '-' . '-' . $detail_konten->judul . '-' . 'gambar-10' . '.' . $gambar_10->extension();
            $gambar_10->move(public_path('assets/img/konten/'.$detail_konten->konten->topik), $imageName10);
        } else {
            $imageName10 = $data_konten->gambar_10;
        }

        if ($request->hasFile('gambar_11')) {
            // Hapus file foto sebelumnya dari penyimpanan
            if ($data_konten->gambar_11 && file_exists(public_path('assets/img/konten/'.$detail_konten->konten->topik.'/'. $data_konten->gambar_11))) {
                unlink(public_path('assets/img/konten/'.$detail_konten->konten->topik.'/'. $data_konten->gambar_11));
            }

            $gambar_11 = $request->file('gambar_11');
            $imageName11 = now()->format('ymdHis') . '-' . '-' . $detail_konten->judul . '-' . 'gambar-11' . '.' . $gambar_11->extension();
            $gambar_11->move(public_path('assets/img/konten/'.$detail_konten->konten->topik), $imageName11);
        } else {
            $imageName11 = $data_konten->gambar_11;
        }
        ...
        $data_konten->update([
            ...
            'isi_konten_5' => $request->isi_konten_5,
            'isi_konten_6' => $request->isi_konten_6,
            'gambar_1' => $imageName1,
            'gambar_2' => $imageName2,
            'gambar_3' => $imageName3,
            'gambar_4' => $imageName4,
            ...
            'gambar_8' => $imageName8,
            'gambar_9' => $imageName9,
            'gambar_10' => $imageName10,
            'gambar_11' => $imageName11,
        ]);

...
class Layout5Controller extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $data_konten->quote = $request->quote;
    ...
    public function show(string $id)
    {
        ...
        return view('pages/admin/layout/layout5', compact('detail_konten'));
    }
    ...
    public function update(Request $request, string $id)
    {
        ...
        $detail_konten = DetailKonten::findOrFail($request->id);
        $data_konten = Layout5::findOrFail($id);
        ...
        if ($request->hasFile('gambar_4')) {
            ...
            $imageName4 = $data_konten->gambar_4;
        }    

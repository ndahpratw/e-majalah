                    ...
                    <div class="col-md-10 col-lg-6 col-xl-5 order-2 order-lg-1">
                      ...
                      <form class="mx-1 mx-md-4" method="post" action="/register">
                        ...
                        <div class="d-flex flex-row align-items-center mb-4">
                          ...
                          <div data-mdb-input-init class="form-outline flex-fill mb-0">
                            <input type="number" name="telepon" id="form3Example4cd" class="form-control @error('telepon') is-invalid @enderror" value="{{old('telepon')}}" placeholder="contoh:62xxx" />
                            @error('telepon')
                            <div class="invalid-feedback">
                                {{ $message }}
                            </div>
                        ...
                        <div class="d-flex flex-row align-items-center mb-4">
                          ...
                          <div data-mdb-input-init class="form-outline flex-fill mb-0">
                            <input type="text" name="instansi" id="form3Example4cd" class="form-control" value="{{old('instansi')}}"  placeholder="Lewati jika tidak ada"/>
                            <label class="form-label" for="form3Example4cd">Instansi Asal</label>
                          </div>
                        </div>

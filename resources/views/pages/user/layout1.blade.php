                ...
                <div class="grid-container">
                    <div class="column">
                        <div class="image-container">
                            <img src="{{ asset('assets/img/foto1.jpg') }}" class="landscape" alt="">
                            <img src="{{ asset('assets/img/foto6.png') }}" class="potrait mt-4" alt="">
                        </div>
                    </div>

                    <div class="column">
                        <div class="image-container">
                            <img src="{{ asset('assets/img/foto3.jpg') }}" class="landscape" alt="">
